				...
				<div class="web_login" id="web_login">
					...
					<div class="login-box">
						...
						<div class="login_form">
							<form action="<?php echo U(GROUP_NAME.'/Login/loginHandler');?>" name="loginform" accept-charset="utf-8" id="login_form" class="loginForm" method="post">
						...
						<ul class="reg_form" id="reg-ul">
							...
							<li>
								...
								<div class="inputOuter2">
									...
									<input type="text" id="code" name="code" maxlength="4" class="inputstyle2" />
									<img src="<?php echo U(GROUP_NAME.'/Login/verify');?>" alt="" onclick="tog(this)"/>
								</div>
